          ...
          <div className="about-card-glass mb-5">
            <div className="row align-items-center g-5">
              ...
              <div className="col-lg-8">
                ...
                <p className="about-paragraph">
                  I love solving real-world problems through clean, type-safe code using <strong>TypeScript</strong>, managing workflows via <strong>Git & GitHub</strong>, containerizing applications with <strong>Docker</strong>, and deploying projects directly to cloud environments like <strong>Render</strong>.
                </p>
