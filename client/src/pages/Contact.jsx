          ...
          <div className="row g-5 align-items-center">
            ...
            <div className="col-lg-5 pe-lg-5 animate-fade-in">
              ...
              <div className="contact-minimal-list">
                <div className="contact-minimal-item">
                  ...
                  <div>
                    ...
                    <a href="mailto:saurabhkhanka222@gmail.com" className="fw-semibold">
                ...
                <div className="contact-minimal-item">
                  ...
                  <div>
                    ...
                    <a href="tel:+919582111994" className="fw-semibold">
                      +91 9582111994
                    </a>
                  </div>
                </div>
              ...
              <div className="d-flex align-items-center gap-3">
                ...
                <a href="https://github.com/Saurabhkhanka" target="_blank" rel="noreferrer" className="social-pill github">
